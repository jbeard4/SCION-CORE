...
(function (root, factory) {
    ...
    function getTransitionWithHigherSourceChildPriority(_arg) {
        ...
        if(!t1.event && t2.event) return t1;
        if(t1.event && !t2.event) return t2;
    ...
    BaseInterpreter.prototype = {
        ...
        _performBigStep : function(e) {
            ...
            while (keepGoing) {
                ...
                this._performSmallStep(currentEvent, eventlessTransitions);
        ...
        /** @private */
        _performSmallStep : function(currentEvent, transitions) {
